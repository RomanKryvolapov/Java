...
//Метод a.concat >> время выполнения    1 560 372 наносекунд
//
//Проверка >> Длинна а = 1000
//Метод a = a + b >> время выполнения   44 686 016 наносекунд
//
//Проверка >> Длинна а = 1000
//Метод StringBuilder >> время выполнения    4 367 506 наносекунд
//
//Проверка >> Длинна а = 1000
//Метод StringBuffer >> время выполнения    3 780 479 наносекунд
